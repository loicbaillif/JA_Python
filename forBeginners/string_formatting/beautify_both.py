...
#  ****** String Formatting: Exercise - Beautify both output and code ******
...
# programmer. Now it's up to you to decide, which formatting method to choose.
#
...
# user, depending on their name and profession. 
# The base would be something like
#
#       "http://example.com/*nickname*/desirable/*profession*/profile"
#  where nickname and profession are prompts from a user and are dynamic.
#
